...
mri_3d_img_tr_dir = 'your/base/path/FM_experiments/imagesTr'
mri_3d_label_tr_dir = 'your/base/path/FM_experiments/labelsTr'
mri_3d_img_ts_dir = 'your/base/path/FM_experiments/imagesTs'
mri_3d_label_ts_dir = 'your/base/path/FM_experiments/labelsTs'

mri_2d_img_tr_dir = 'your/base/path/FM_experiments/slice_128_128/imagesTr_slice'
mri_2d_label_tr_dir = 'your/base/path/FM_experiments/slice_128_128/labelsTr_slice'
mri_2d_img_ts_dir = 'your/base/path/FM_experiments/slice_128_128/imagesTs_slice'
mri_2d_label_ts_dir = 'your/base/path/FM_experiments/slice_128_128/labelsTs_slice'

support_set_dir = 'your/base/path/FM_experiments/slice_128_128/support_set'
selection_list = ['smallest', 'middle', 'largest']
selection = selection_list[2]
threshold = 0.9
pred_save_dir = f'your/base/path/FM_experiments/experiment_universeg/{selection}_{threshold}'
'''
