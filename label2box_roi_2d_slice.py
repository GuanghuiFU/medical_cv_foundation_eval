...
folder_path = 'your/label/folder/path'
excel_save_path = 'your/box/prompt/save/path/2d-gt-single.csv'

calculate_rectangle_coordinates_and_size_per_file(folder_path, excel_save_path)
